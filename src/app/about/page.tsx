...
export const metadata: Metadata = {
  title: 'About',
  description:
    'I’m Jacques Beukes. I live in South Africa, where I craft decentralized solutions.',
}
      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          <h1 className="text-3xl font-bold tracking-tight text-zinc-800 dark:text-zinc-100 sm:text-5xl">
            I’m Jacques Beukes, an entrepreneurial architect.
          </h1>
        ...
        <div className="lg:pl-20">
          <ul role="list">
            <SocialLink
              href="https://twitter.com/JacquesBeukes18"
              icon={TwitterIcon}
            >
              Follow on Twitter
            </SocialLink>
            <SocialLink
              href="https://github.com/JPBeukes"
              icon={GitHubIcon}
              className="mt-4"
            >
              Follow on GitHub
            ...
            <SocialLink
              href="https://www.linkedin.com/in/jacques-beukes-3a7072223/"
              icon={LinkedInIcon}
              className="mt-4"
            >
              Follow on LinkedIn
